...
namespace HerosQuest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                ranger ranger; mage mage; barbarian barbarian;
                ...
                while (winner == null)
                {
                    ...
                    if (ranger.Health > 0)
                    {
                        ...
                        if (mage.Health <= 0 && barbarian.Health <= 0)
                        {
                            winner = ranger;
                            continue;
                        }
                    ...
                    if (mage.Health > 0)
                    {
                        ...
                        if (ranger.Health <= 0 && barbarian.Health <= 0)
                        {
                            winner = mage;
                            continue;
                        }
                    ...
                    if (barbarian.Health > 0)
                    {
                        ...
                        if (ranger.Health <= 0 && mage.Health <= 0)
                        {
                            winner = barbarian;
                            continue;
                        }
        ...
        private static void SetupCharacters(out ranger ranger, out mage mage, out barbarian barbarian)
        {
        ...
        private static void TakeRangerTurn(ranger ranger, mage mage, barbarian barbarian)
        {
            string rangerMenu = "1. Rest.\r\n" +
                                "2. Take potion of healing.\r\n" +
                                "3. Take potion of vitality.\r\n" +
                                "4. Fire arrow at " + mage.Name + " the mage.\r\n" +
                                "5. Fire arrow at " + barbarian.Name + " the barbarian.\r\n" +
                                "6. Collect arrows.\r\n";
            ...
            {
                Console.WriteLine(ranger.Name + " it is your turn!");
            ...
            {
                Console.WriteLine("You are no longer allied with " + ranger._Allied.Name);
                ranger._Allied = null;
            }
        }
        ...
        /// <param name="barbarian">Barbarian character opponent</param>
        private static void TakeMageTurn(ranger ranger, mage mage, barbarian barbarian)
        {

            string mageMenu = "1. Rest.\r\n" +
                                            "2. Take potion of healing.\r\n" +
                                            "3. Take potion of vitality.\r\n" +
                                            "4. Throw fireball at " + ranger.Name + " the ranger.\r\n" +
                                            "5. Throw fireball at " + barbarian.Name + " the barbarian.\r\n" +
                                            "6. Cast healing spell on yourself.\r\n" +
                                            "7. Cast healing spell on " + ranger.Name + " the ranger.\r\n" +
                                            "   You will become allies for " + ranger.Name + "'s next turn.\r\n" +
                                            "8. Cast healing spell on " + barbarian.Name + " the barbarian.\r\n" +
                                            "   You will become allies for " + barbarian.Name + "'s next turn.\r\n";
            ...
            do
            {
                Console.WriteLine(mage.Name + " it is your turn!");
        ...
        private static void TakeBarbarianTurn(ranger ranger, mage mage, barbarian barbarian)
        {
            string barbarianMenu = "1. Rest.\r\n" +
                                            "2. Take potion of healing.\r\n" +
                                            "3. Take potion of vitality.\r\n" +
                                            "4. Swing axe at " + ranger.Name + " the ranger.\r\n" +
                                            "5. Swing axe at " + mage.Name + " the mage.\r\n";
            bool successfulAction = false;
            ...
            do
            {
                Console.WriteLine(barbarian.Name + " it is your turn!");
            ...
            {
                Console.WriteLine("You are no longer allied with " + barbarian._Allied.Name);
